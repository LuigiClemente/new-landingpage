...
darkColor : "rgb(255 48 22)",
      linearGradient:
        "linear-gradient(rgb(17, 17, 34) 7.5%, rgb(248, 79, 57) 20%)",
      cardName: " Data Apis",
      icon: "/assets/card-icons/fat.svg",
    ...
    },
    {
      ...
      linearGradient:
        "linear-gradient(rgb(17, 17, 34) 8%,#009788 30%, #009788)",
  
      cardName: " Data Modeling",
      bottomIcon: "/assets/card-icons/fat.svg",
      ...
      longSecDescription:
        "Whether you’re building an internal application, a dashboard, or an embedded analytics application, ensure they’ll all be powered by consistent data—and skip manually orchestrating metrics for each presentation layer. Combined with Cube’s advanced caching and pre-aggregation capabilities, this ensures that every downstream app stays updated with the latest information—cost-effectively and with low latency.",
      longSecImage: "/assets/images/data-modeling-feature-1.svg",
      smallSections: [
        {
    ...
    },
    {
      ...
      cardOffset : 0.5,
darkColor : "#e79602",
      bottomIcon: "/assets/card-icons/nutrition.svg",
      linearGradient:
        "linear-gradient(rgb(17, 17, 34) 8%, #ffa500 30%, #ffa500)",
...
darkColor : "rgb(239 200 37)",
      linearGradient:
        "linear-gradient(rgb(17, 17, 34) 7.5%, #DDAF29 20%)",
        bottomIcon: "/assets/card-icons/sugar.svg",
