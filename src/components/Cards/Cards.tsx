...
const Cards = ({ title, description }: Props) => {
  ...
  return (
    <div className="CubeSchema_CubeSchema__cube__aVGJu relative" style={{ maxWidth: "600px", maxHeight: "600px", margin: 'auto' }}>
      <a
      ...
      >
        <div>
          <p className="CubeSchema_CubeSchema__card_title__gND6b">
            {animationCards[1].title}
          </p>
          <p className="CubeSchema_CubeSchema__card_content__K1bdM">
            {animationCards[1].description}
          </p>
        </div>
        <div className="CubeSchema_CubeSchema__card_footer__YU7RW flex justify-end">
          <img
            className="CubeSchema_CubeSchema__card_badge__1a_FX w-8 sm:w-[3.5vw] xl:w-[3rem]"
            src={"/card-icons/nutrition.svg"}
            width="32"
            height="32"
            alt="Access Control badge"
          />
          <div
            style={{ cursor: "pointer" }}
            className="CubeSchema_CubeSchema__card_readMore__ovs9v"
      ...
      >
        <div>
          <p className="CubeSchema_CubeSchema__card_title__gND6b">
            {animationCards[2].title}
          </p>
          <p className="CubeSchema_CubeSchema__card_content__K1bdM">
            {animationCards[2].description}
          </p>
        </div>
        <div className="CubeSchema_CubeSchema__card_footer__YU7RW">
          <img
            className="CubeSchema_CubeSchema__card_badge__1a_FX w-9 sm:w-[4vw] xl:w-[3.2rem] xl:mt-11"
            src={"/card-icons/sugar.svg"}
            width="32"
            height="32"
            alt="APIs badge"
          />
          <div
            style={{ cursor: "pointer" }}
            onClick={() => onPressReadMore("Caching")}
            className="CubeSchema_CubeSchema__card_readMore__ovs9v"
          >
            Read more
            <svg
      ...
      >
        <div>
          <p className="CubeSchema_CubeSchema__card_title__gND6b">
            {animationCards[3].title}
          </p>
          <p className="CubeSchema_CubeSchema__card_content__K1bdM">
            {animationCards[3].description}
          </p>
        </div>
        <div className="CubeSchema_CubeSchema__card_footer__YU7RW">
          <img
            className="CubeSchema_CubeSchema__card_badge__1a_FX w-6 sm:w-[2.6vw] xl:w-9"
            src={"/card-icons/fat.svg"}
            width="32"
            height="32"
            alt="Caching badge"
          />
